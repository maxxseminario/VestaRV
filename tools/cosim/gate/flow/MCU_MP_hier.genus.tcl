...
set TOP_MODULE       MCU
set BASENAME         MCU_MP_hier.genus
set NUM_HARTS        4
...
# of MCU.vhd with EVERY '=> CORE_*' association stripped from the hart
# generic maps (they pass the entity defaults = the shipped default
...
puts "Genus MCU_MP_hier run is complete. Run time $total_run_time"
