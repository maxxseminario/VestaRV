#!/usr/bin/env python3
# VestaRV: the Myshkin-era chip generator entry point, kept for that chip's artifacts.
# The current chip is generated by platform/common/python/generate.py; this reads the
# shared ChipGenerator through a relative path and is not part of the platform build.
