...
PERIPHERALS = {
    ...
    'POTENTIOSTAT': {
        ...
        'registers': {
            ...
            'BIAS_DBPC': {'addr': 0x4C1C, 'size': 2, 'bits': 14, 'type': 'BIAS', 'description': 'Bias DAC BPC register'},
            'BIAS_DBNC': {'addr': 0x4C20, 'size': 2, 'bits': 14, 'type': 'BIAS', 'description': 'Bias DAC BNC register'},
            'BIAS_DBN': {'addr': 0x4C24, 'size': 2, 'bits': 14, 'type': 'BIAS', 'description': 'Bias DAC BN register'},
