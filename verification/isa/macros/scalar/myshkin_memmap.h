// VestaRV: Myshkin peripheral base addresses and register offsets
// UNUSED AND UNINCLUDED: nothing in the tree includes this file, and the register-offset lines below carry no #define, so it would not compile if anything did. The live copies are myshkin.h and myshkin_s.h.
