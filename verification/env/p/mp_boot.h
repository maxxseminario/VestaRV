...
//     0x10400 + 0x10*h + 0x0 = SRC   (word-aligned shared-space address)
//     0x10400 + 0x10*h + 0x4 = LEN   (words to copy to TCM; 0 = no copy)
//     0x10400 + 0x10*h + 0x8 = ENTRY (PC the tile enters with)
//
...
// whole test/mailbox ledger at 0x100xx-0x104xx. A full-TCM stage/copy (4096
...
#define MP_BOOT_MB_BASE  0x10400
