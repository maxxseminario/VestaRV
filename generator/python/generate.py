...
m = ChipGenerator(
	...
	mcuUserGuideLatexTemplateFileName='MCU-User-Guide.template.tex',
	...
	ramMemorySlotsMuxed={},	# No MUXed RAM slots
	...
	vectorsCount=64, # Change this to 83 and change the code to enable non powers of two or go the next power of two ...
	padOutPosLogic=True,
...
''' SARADC '''
p = PeripheralTemplate(nameTemplate='SARADCx', description='Successive Approximation Register Analog-to-Digital Converter with 4 channels', registerPrefix='SARADC', bitFieldPrefix='SARADC')
m.AddPeripheralTemplate(p)

# SARADCCR
r = RegisterTemplate(nameTemplate='SARADCxCR', registerMemorySlot=0, description='SAR ADC control register', size=16)
p.AddRegisterTemplate(r)
...
r.AddBitField(BitField(name='SARADCSAMPLESTEP', msb=4, lsb=1, description='Sampling step/pulse width', accessibility='rw'))
...
# SARADCCDIV
r = RegisterTemplate(nameTemplate='SARADCxCDIV', registerMemorySlot=1, description='SAR ADC clock divider register', size=8)
p.AddRegisterTemplate(r)

r.AddBitField(BitField(name='SARADCCDIV', msb=7, lsb=0, description='Clock divider value', accessibility='rw'))

# SARADCSR
r = RegisterTemplate(nameTemplate='SARADCxSR', registerMemorySlot=2, description='SAR ADC status register', size=8)
p.AddRegisterTemplate(r)
...
r.AddBitField(BitField(name='SARADCDATAVALID', msb=1, description='Data valid flag', accessibility='r', valueDescriptions=[(0b0, 'Data not valid'), (0b1, 'Data valid')]))
...
# SARADCDATA
r = RegisterTemplate(nameTemplate='SARADCxDATA', registerMemorySlot=3, description='SAR ADC data register', size=16)
p.AddRegisterTemplate(r)
...
# SARADCTPR
r = RegisterTemplate(nameTemplate='SARADCxTPR', registerMemorySlot=4, description='SAR ADC test port register', size=8)
p.AddRegisterTemplate(r)
...
m.CreatePeripheral(nameTemplate='NNx', nameIndex=0, peripheralMemorySlot=10, interruptPriority=None)	# NPU0 at 0x4A00
m.CreatePeripheral(nameTemplate='SARADCx', nameIndex='0', peripheralMemorySlot=11, interruptPriority=56)	# SARADC0 at 0x4B00
m.CreatePeripheral(nameTemplate='AFEx', nameIndex=0, peripheralMemorySlot=12, interruptPriority=55)	# AFE0 at 0x4C00
...
package.AddPin(packagePinNumber=34, name='ECS0.CE', ioType='o', powerDomain=analogPowerDomain)
package.AddPin(packagePinNumber=33, name='ECS0.RE', ioType='o', powerDomain=analogPowerDomain)
...
GPIO0.AddGpio(GpioConfigurator(bitNumber=0, primaryName='', funcName='CS_FLASH', funcIOType='o',	rstOUT=1, rstDIR=1, rstSEL=0, rstREN=0, description='Chip select pin for SPI flash memory'), packagePinNumber=31) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=1, primaryName='', funcName='MISO0', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='SPI0 Master In Slave Out (connected to SPI flash memory)'), packagePinNumber=30) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=2, primaryName='', funcName='MOSI0', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='SPI0 Master Out Slave In (connected to SPI flash memory)'), packagePinNumber=29) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=3, primaryName='', funcName='SCK0', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='SPI0 serial clock (connected to SPI flash memory)'), packagePinNumber=28) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=4, primaryName='', funcName='LFXT', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='Low frequency external clock'), packagePinNumber=27) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=5, primaryName='', funcName='HFXT', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='High frequency external clock'), packagePinNumber=26) # necessary
GPIO0.AddGpio(GpioConfigurator(bitNumber=6, primaryName='', funcName='TRAP', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='CPU trap state'), packagePinNumber=25) # necessary
...
GPIO1.AddGpio(GpioConfigurator(bitNumber=0, primaryName='', funcName='CS1', funcIOType='i',		rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='SPI1 chip select'), packagePinNumber=20) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=1, primaryName='', funcName='MISO1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='SPI1 Master In Slave Out'), packagePinNumber=19) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=2, primaryName='', funcName='MOSI1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='SPI1 Master Out Slave In'), packagePinNumber=18) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=3, primaryName='', funcName='SCK1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='SPI1 serial clock'), packagePinNumber=17) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=4, primaryName='', funcName='TX0', funcIOType='o',		rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='UART0 transmitter'), packagePinNumber=16) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=5, primaryName='', funcName='RX0', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=1, rstREN=0, description='UART0 receiver'), packagePinNumber=15) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=6, primaryName='', funcName='TX1', funcIOType='o',		rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='UART1 transmitter'), packagePinNumber=14) # necessary
GPIO1.AddGpio(GpioConfigurator(bitNumber=7, primaryName='', funcName='RX1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='UART1 receiver'), packagePinNumber=13) # necessary

# GPIO2 (P3.0-P3.7)
GPIO2.ChangeGPIOPortSize(8)

GPIO2.AddGpio(GpioConfigurator(bitNumber=0, primaryName='', funcName='T0CMP0', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER0 Compare 0'), packagePinNumber=9) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=1, primaryName='', funcName='T0CMP1', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER0 Compare 1'), packagePinNumber=8) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=2, primaryName='', funcName='T0CAP0', funcIOType='i',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER0 Capture 0'), packagePinNumber=7) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=3, primaryName='', funcName='T0CAP1', funcIOType='i',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER0 Capture 1'), packagePinNumber=6) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=4, primaryName='', funcName='T1CMP0', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER1 Compare 0'), packagePinNumber=5) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=5, primaryName='', funcName='T1CMP1', funcIOType='o',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER1 Compare 1'), packagePinNumber=4) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=6, primaryName='', funcName='T1CAP0', funcIOType='i',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER1 Capture 0'), packagePinNumber=3) # necessary
GPIO2.AddGpio(GpioConfigurator(bitNumber=7, primaryName='', funcName='T1CAP1', funcIOType='i',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='TIMER1 Capture 1'), packagePinNumber=2) # necessary

# GPIO3 (P4.0-P4.7)
GPIO3.ChangeGPIOPortSize(8)

GPIO3.AddGpio(GpioConfigurator(bitNumber=0, primaryName='', funcName='SDA0', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='I2C0 serial data'), packagePinNumber=1) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=1, primaryName='', funcName='SCL0', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='I2C0 serial clock'), packagePinNumber=44) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=2, primaryName='', funcName='SDA1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='I2C1 serial data'), packagePinNumber=43) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=3, primaryName='', funcName='SCL1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='I2C1 serial clock'), packagePinNumber=42) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=4, primaryName='', funcName='DTP0', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='Digital test port 0'), packagePinNumber=41) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=5, primaryName='', funcName='DTP1', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='Digital test port 1'), packagePinNumber=40) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=6, primaryName='', funcName='DTP2', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='Digital test port 2'), packagePinNumber=39) # necessary
GPIO3.AddGpio(GpioConfigurator(bitNumber=7, primaryName='', funcName='DTP3', funcIOType='io',	rstOUT=0, rstDIR=0, rstSEL=0, rstREN=0, description='Digital test port 3'), packagePinNumber=38) # necessary
