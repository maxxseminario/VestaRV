################################################################################
#
# Genus TCL script (DP-S3 POWER-PURPOSED re-synth, 2026-07-24: staged DP-S3 castalia_dp RTL from genus/in/dp_s3_hdl; derived from MCU_DP_hier.genus.tcl, Stage F2a: staged CastaliaDP fabric + QSPI/RTC/PWM/DMA; derived from MCU_MP_hier) -- MCU_MP HIERARCHICAL TOP (M14 physical flow)
#
...
set DP_HDL        /home/mseminario2/vestarv/genus/in/dp_s3_hdl

set TOP_MODULE       MCU
set BASENAME         MCU_DP_hier_s3.genus
set NUM_HARTS        4
...
' ../hart_tile/out/hart_tile.genus.v > $INPUT_DIR/hart_tile_top_s3.gen.v"
read_hdl $INPUT_DIR/hart_tile_top_s3.gen.v
...
exec bash -c "sed -e '/=> CORE_ENABLE_/d' \
	...
	$DP_HDL/MCU.vhd > $INPUT_DIR/MCU_top_s3.gen.vhd"
read_hdl -vhdl -library work $INPUT_DIR/MCU_top_s3.gen.vhd
