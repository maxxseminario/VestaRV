...
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/fixed_float_types_c.vhdl
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/fixed_pkg_c.vhdl
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/FPMac.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/FPSigmoid.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/TieLow.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/constants.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/macros/macros.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/MemoryMap.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/TieLow.vhd 
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/ClkGate_cmn65gp_ARM.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/ClockMuxGlitchFree_cmn65gp_ARM.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/CRC16.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/commune/ClkDivPower2.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/GPIO.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/SPI.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/UART.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/I2C.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/TIMER.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/SYSTEM.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/NPU.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/SARADC.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/AFE_FSM.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/periph/AFE.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/div.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/alu.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/extend.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/regfile_sbirq.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/irq_handler.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/loadext.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/store_ext.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/branch_valid.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/csr_unit.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/datapath.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/maindec.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/controller.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/c_dec.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/vesta/vesta.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/adddec.vhd
read_hdl -vhdl -library work $HDL_DIR/myshkin/$TOP_MODULE.vhd
