#!/bin/bash
# Parallel rv32ui test runner — POST-SYNTHESIS (genus) gate-level sim with SDF.
#
# Same wrapper-per-test strategy as behavioral/xrun_parallel.sh, but the design
# under test is the synthesized gate netlist (../../../genus/out/MCU.genus.v) and
...
CELL_LIST="$RUN_DIR/cell_list_genus.txt"
