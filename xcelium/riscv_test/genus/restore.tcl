...
#
#      xrun -top riscv_tb -sdf_cmd_file MCU.sdfcmd -sdfstats log/sdf_stats.log -sdf_verbose -v200x -work work -access +r -controlrelax nlstex -relax -input ./restore.tcl -input ../../disable_x_warnings.tcl /home/mseminario2/lib/TSMC65-IP/tsmc/pads/tphn65gpgv2od3_sl/verilog/tphn65gpgv2od3_sl.v /opt/design_kits/TSMC65-IP/arm/sc10/hvt/aci/sc-ad10/verilog/tsmc65_hvt_sc_adv10.v ../../../hdl/MCU/constants.vhd ../../../hdl/MCU/macros/macros.vhd ../../../hdl/MCU/MemoryMap.vhd ../../../hdl/MCU/tb/serial_flash.vhd ../../../hdl/MCU/sim/GlitchFilter_behav.vhd ../../../hdl/MCU/sim/PowerOnResetCheng_behav.vhd ../../../hdl/MCU/sim/OscillatorCurrentStarved_simulation.vhd ../../../ip/rom_hvt_pg/rom_hvt_pg.v ../../../ip/sram1p16k_hvt_pg/sram1p16k_hvt_pg.v ../../../ip/sram1p8k_hvt_pg/sram1p8k_hvt_pg.v ../../../ip/sram1p1k_hvt_pg/sram1p1k_hvt_pg.v ../../../genus/out/MCU.genus.v ../../../hdl/MCU/tb/tb_defs.vhd ../../../hdl/MCU/tb/riscv_tb.vhd ../../../hdl/MCU/tb/riscv_tb.vhd -input restore.tcl
#
...
probe -create -database waves :spi_slave_flash:SPCLK :spi_slave_flash:MOSI :spi_slave_flash:MISO :spi_slave_flash:CSb
probe -create -database waves :load_data :spi_we :spi_re :spi_mosi :spi_miso :spi_cs :spi_clk :spi_busy :spi_slave_flash:state :spi_slave_flash:SPCLK :spi_slave_flash:MOSI :spi_slave_flash:MISO :spi_slave_flash:mem_reset :spi_slave_flash:CSb
probe -create -database waves :dut.spi0.en_clk_baud_src
probe -create -database waves :spi_slave_flash:mem_reset :spi_slave_flash:RAM_FILE_PATH
probe -create -database waves :dut.spi0.clk_baud
probe -create -database waves :flash_word
probe -create -database waves :dut.spi1.wen
probe -create -database waves :spi_slave_flash:ReadyBit
...
probe -create -database waves :dut.gpio1.write_data :dut.gpio1.wen :dut.gpio1.read_data :dut.gpio1.addr_periph :dut.spi1.SPIxTX :dut.spi1.SPIxCR :dut.spi1.s_SPIxRX :dut.spi1.write_data :dut.spi1.read_data :dut.spi1.s_rx_sreg :dut.spi1.s_tx_sreg :dut.spi1.s_counter :dut.spi1.sck_in :dut.spi1.sck_slave :dut.spi1.mosi_in :dut.spi1.miso_out :dut.spi1.cs_in :dut.spi0.en_mem :dut.spi0.clk_mem :dut.spi0.read_data :dut.spi0.write_data :dut.spi0.wen :dut.spi0.SPIxTX :dut.spi0.SPIxCR :dut.spi0.m_rx_sreg :dut.spi0.miso_in :dut.spi0.m_tx_sreg :dut.spi0.clk_baud :dut.spi0.m_counter :spi_slave_flash:state :spi_slave_flash:SPCLK :spi_slave_flash:MOSI :spi_slave_flash:CSb :spi_slave_flash:MISO :spi_slave_flash:TXSr :spi_slave_flash:\$PROCESS_000:Address :spi_slave_flash:PowerOn :spi_slave_flash:ReadyBit :spi_slave_flash:RXSr :prt1 :dut.prt1_ren :dut.prt1_dir :dut.prt1_out :dut.prt1_in :prt2 :prt2_dir :prt2_in :prt2_out :prt2_ren :gpio0_drv_sig :gpio0_oe_sig :gpio1_drv_sig :gpio1_oe_sig :spi_slave_flash:mem_reset :dut.mem_addr :dut.gpio0.alt_func_out_in :dut.gpio0.alt_func_dir_in :dut.gpio0.prt_dir_out :dut.gpio0.alt_func_ren_in :dut.gpio0.PxDIR :dut.gpio0.PxOUT :dut.gpio0.PxSEL :dut.gpio0.read_data :dut.gpio0.write_data :dut.gpio0.prt_out_out :dut.gpio1.PxDIR :dut.gpio1.PxOUT :dut.gpio1.PxSEL
...
probe -create -database waves :prt3 :prt4 :prt1_in :prt1_out
probe -create -database waves :dut.core.controller_inst.md.op :dut.core.controller_inst.md.funct3 :dut.core.controller_inst.md.funct7
probe -create -database waves :resetn
probe -create -database waves :dut.core.reg_write_dp
probe -create -database waves :gpio0_drv_sig :gpio0_oe_sig
...
probe -create -database waves :dut.adddec0.wen
probe -create -database waves :dut.core.amo_write_data :dut.core.write_data_dp
...
probe -create -database waves :dut.core.sleep_cpu :dut.core.sleep_rq :dut.core.wake_rq :dut.core.clk :dut.core.clk_cpu
probe -create -database waves :dut.miso1_out :dut.gpio1.alt_func_dir_in :dut.gpio1.alt_func_out_in :dut.gpio1.alt_func_ren_in
...
probe -create -database waves :dut.core.datapath_inst.loadextender.read_data
...
probe -create -database waves :spi_slave_flash:ProgramAddress :spi_slave_flash:awake :dut.@{\mem_dout[0] } :dut.clk_mem[0]
...
probe -create -database waves :dut.system0.mclk_divider :dut.system0.mclk_undiv
...
probe -create -database waves :spi_slave_flash:PowerOn
...
probe -create -database waves :dut.smclk
...
probe -create -database waves :dut.mclk
probe -create -database waves :dut.afe0.addr_periph :dut.afe0.en_mem :dut.afe0.clk :dut.afe0.clk_mem :dut.afe0.AFE_CR
probe -create -database waves :dut.core.pc_next_ret :dut.core.pc_next_ret_ltch
...
probe -create -database waves :current_test
...
probe -create -database waves :spi_test
probe -create -database waves :dut.GWEN
probe -create -database waves :dut.core.datapath_inst.extended_data :dut.core.datapath_inst.funct3 :dut.core.datapath_inst.write_data_reg_val
probe -create -database waves :dut.spi0.tx_in_progress
probe -create -database waves :dut.uart0.ud_cntr
...
probe -create -database waves :dut.system0.unlock :dut.system0.clk_unlock :dut.system0.unlocked
...
probe -create -database waves :prt2 :prt2_dir :prt2_in :prt2_out :prt2_ren :gpio1_drv_sig :gpio1_oe_sig :dut.gpio1.write_data :dut.gpio1.wen :dut.gpio1.read_data :dut.gpio1.addr_periph :dut.gpio1.PxDIR :dut.gpio1.PxOUT :dut.gpio1.PxSEL :dut.spi1.SPIxTX :dut.spi1.SPIxCR :dut.spi1.mosi_in :dut.spi1.miso_out :dut.spi1.cs_in :dut.spi1.sck_in
probe -create -database waves :dut.prt2_dir :dut.prt2_out :dut.prt2_in
probe -create -database waves :load_data
...
probe -create -database waves :spi_slave_flash:state
probe -create -database waves :dut.core.pc_next
probe -create -database waves :dut.core.datapath_inst.alu_control
probe -create -database waves :dut.system0.smclk_divider :dut.system0.smclk_undiv
probe -create -database waves :spi_slave_flash:\$PROCESS_000:Address
...
probe -create -database waves :spi_slave_flash:TXSr
probe -create -database waves :dut.core.reservation_addr :dut.core.datapath_inst.src_a :dut.core.datapath_inst.amo_phase :dut.core.datapath_inst.amo_addr_reg
probe -create -database waves :dut.core.datapath_inst.rd_amo
probe -create -database waves :dut.spi1.s_SPIxRX
probe -create -database waves :spi_dout
probe -create -database waves :spi_slave_flash:RXSr
...
probe -create -database waves :dut.system0.mclk_mux.resetn :dut.system0.mclk_mux.Sel :dut.system0.mclk_mux.EnQQQ :dut.system0.mclk_mux.EnQQ :dut.system0.mclk_mux.EnQ :dut.system0.mclk_mux.ClkOut :dut.system0.mclk_mux.ClkEn :dut.system0.mclk_mux.ClkIn
probe -create -database waves :spi_we :spi_re :spi_mosi :spi_miso :spi_flash_din_sig :spi_flash_addr_sig :spi_din :spi_cs :spi_clk :spi_busy
probe -create -database waves :dut.spi0.clr_start_tx
probe -create -database waves :dut.spi0.SPIxRX_ltch
probe -create -database waves :dut.mem_en_periph :dut.gpio0.alt_func_out_in :dut.gpio0.alt_func_dir_in :dut.gpio0.prt_dir_out :dut.gpio0.alt_func_ren_in :dut.gpio0.PxOUT :dut.gpio0.PxSEL :dut.gpio0.write_data :dut.gpio0.prt_out_out :dut.gpio0.wen :dut.gpio0.addr_periph :dut.gpio0.en :dut.gpio0.PxDIR :dut.prt1_ren :dut.prt1_dir :dut.prt1_out :dut.prt1_in :load_data :spi_mosi :spi_miso :spi_cs :spi_clk :spi_busy :spi_slave_flash:state :spi_slave_flash:SPCLK :spi_slave_flash:MOSI :spi_slave_flash:MISO :spi_slave_flash:mem_reset :spi_slave_flash:CSb
...
probe -create -database waves :load_data :spi_we :spi_re :spi_mosi :spi_miso :spi_flash_din_sig :spi_flash_addr_sig :spi_dout :spi_din :flash_word :spi_cs :spi_clk :spi_busy :spi_slave_flash:state :spi_slave_flash:SPCLK :spi_slave_flash:MOSI :spi_slave_flash:MISO :spi_slave_flash:CSb
...
probe -create -database waves :dut.system0.clk_dco0 :dut.system0.clk_dco1
probe -create -database waves :dut.system0.crc_prev
probe -create -database waves :dut.spi1.en_mem :dut.spi1.clk_mem
probe -create -database waves :dut.core.instr_curr_prev :dut.system0.DCO0_BIAS :dut.system0.DCO1_BIAS
