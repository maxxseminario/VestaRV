...
#        -log log/chip_top_dp_g2p1 -files ../../../signoff_mp/tcl/chip_top_dp_g2_patch2.tcl
...
streamOut \
	$OUTPUT_DIR/chip_top_dp.g2p2.gds2 \
	-libName WorkLib \
...
puts "G2P2: COMPLETE (trial GDS out/chip_top_dp.g2p2.gds2, no saveDesign)"
exit
