...
#   - Count guards; trial streamOut out/MCU_castalia.c6e1c.gds2; NO saveDesign.
#
# Run: cd ~/vestarv/innovus/common/MCU_castalia && innovus -no_gui -batch \
#        -log log/mcu_castalia_c6e1c \
#        -files /home/mseminario2/vestarv/signoff_mp/tcl/mcu_castalia_c6_pass1c.tcl
...
timeDesign -postRoute -hold -outDir $REPORT_DIR/MCU_castalia.c6e1c.hold_pre
...
timeDesign -postRoute -hold -outDir $REPORT_DIR/MCU_castalia.c6e1c.hold_post
...
# ---------------- trial streamOut -------------------------------------------
streamOut \
	$OUTPUT_DIR/MCU_castalia.c6e1c.gds2 \
	-libName WorkLib \
...
puts "C6E1: COMPLETE (trial GDS out/MCU_castalia.c6e1c.gds2, no saveDesign)"
exit
