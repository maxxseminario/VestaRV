...
#   - Count guards; trial streamOut out/MCU_castalia.c6e1d.gds2; NO saveDesign.
#
# Run: cd ~/vestarv/innovus/common/MCU_castalia && innovus -no_gui -batch \
#        -log log/mcu_castalia_c6e1d \
#        -files /home/mseminario2/vestarv/signoff_mp/tcl/mcu_castalia_c6_pass1d.tcl
...
__swire_boxdump VSS M2 $REPORT_DIR/MCU_castalia.c6e1d.vssm2_pre.txt
...
__swire_boxdump VSS M2 $REPORT_DIR/MCU_castalia.c6e1d.vssm2_post.txt
...
# ---------------- trial streamOut -------------------------------------------
streamOut \
	$OUTPUT_DIR/MCU_castalia.c6e1d.gds2 \
	-libName WorkLib \
...
puts "C6E1: COMPLETE (trial GDS out/MCU_castalia.c6e1d.gds2, no saveDesign)"
exit
