...
#        -log log/chip_top_dp_g2p1 -files ../../../signoff_mp/tcl/chip_top_dp_g2_patch1_save.tcl
...
# (streamOut skipped in DB-save rerun — canonical GDS already promoted)
if {0} { streamOut \
...
saveDesign $DATABASE_DIR/chip_top_dp.g2.innovus -def -netlist -rc -tcon
puts "G2P1: COMPLETE (DB chip_top_dp.g2.innovus saved)"
exit
