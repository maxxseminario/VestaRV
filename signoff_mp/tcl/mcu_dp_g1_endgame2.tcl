...
# boundary hops, disjoint from the ripped cones). streamOut out/MCU_DP.g1e3.gds2.
...
#        -log log/mcu_dp_g1e3 -files ../../../signoff_mp/tcl/mcu_dp_g1_endgame2.tcl
...
# irq_tielow trio (M2.S.1 gap-fill + two G.4 square-outs)
__mrg "M2.S.1@1013" irq_tielow M2 {1013.805 482.36 1013.905 482.6}
__mrg "G.4@1006"    irq_tielow M2 {1006.65 484.4 1006.79 484.6}
__mrg "G.4@1049"    irq_tielow M2 {1049.45 484.5 1049.635 485.04}
...
puts "G1E3: COMPLETE (trial GDS out/MCU_DP.g1e3.gds2, no saveDesign)"
exit
