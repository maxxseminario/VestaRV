# G1 trial-1c (2026-07-23): defIn timing-fidelity + shield-aware guard probe.
...
#        -log log/mcu_dp_g1trial1c -files ../../../signoff_mp/tcl/mcu_dp_g1_trial1c.tcl
...
# ---- probe A: flow-exact signoff timing -----------------------------------
setDelayCalMode -SIAware false
setAnalysisMode -analysisType onChipVariation -cppr both
timeDesign -si -signoff -outdir rpt/MCU_DP.g1trial1c.timeDesign.signoff.rpt
setAnalysisMode -checkType hold -skew true
report_timing > rpt/MCU_DP.g1trial1c.hold_pre.rpt
setAnalysisMode -checkType setup -skew true
report_timing > rpt/MCU_DP.g1trial1c.setup_pre.rpt
puts "G1TRIAL TIMING: signoff-recipe pre-edit reports written"
...
# ---- post-edit signoff-recipe hold ----------------------------------------
setAnalysisMode -checkType hold -skew true
report_timing > rpt/MCU_DP.g1trial1c.hold_post.rpt
