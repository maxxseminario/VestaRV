...
# boundary hops, disjoint from the ripped cones). streamOut out/MCU_DP.g1e5.gds2.
...
#        -log log/mcu_dp_g1e5 -files ../../../signoff_mp/tcl/mcu_dp_g1_endgame5.tcl
...
if {$__n881 ne ""} {
	...
	puts "G1E3 NOTE: no M2 net at the 881 pin-stub window this pass"
}
...
puts "G1E3: COMPLETE (trial GDS out/MCU_DP.g1e5.gds2, no saveDesign)"
exit
