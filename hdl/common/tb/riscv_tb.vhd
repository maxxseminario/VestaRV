...
-- Multi-hart tb: 5 harts = hart 0 (pass/fail gate) + 4 tile monitor(s) a0_1..a0_4.
-- =====================================================================
...
architecture behavioral of riscv_tb is
    ...
    -- M3b: a0 of the 4 private-memory harts (boot from preloaded RAM at 0x8200)
    ...
    -- M3b: latched pass/fail for private-memory harts 1-4
