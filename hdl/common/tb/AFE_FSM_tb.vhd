-- VestaRV: AFE dual-slope FSM testbench
...
-- Directed bench for the dual-slope conversion FSM: two conversions, one ended by the comparator and one left to time out, so both exit paths are exercised.
