-- VestaRV: TRNG bench support package
-- bench-support helpers for the TRNG peripheral testbench: register-map constants, bus plumbing, bounded SR polls, the reference SEED and TAPS, and a pure single-step Galois LFSR function.
