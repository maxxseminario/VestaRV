-- VestaRV: FPSigmoid testbench
-- Drives every possible input through FPSigmoid.vhd for the configured generics and compares each output against the expected integer in sig_approx_fp.txt, which must sit in the simulation directory and is generated by FPSigmoid_test.m.
