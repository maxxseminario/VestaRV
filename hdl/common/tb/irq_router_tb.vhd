-- VestaRV: interrupt router testbench
-- unit proof for the PLIC-lite irq_router: routing rows, registered meip reduction, CLAIM and COMPLETE semantics, status words and the WDT hooks.
