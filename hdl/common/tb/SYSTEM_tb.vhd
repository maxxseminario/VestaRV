-- VestaRV: SYSTEM testbench
-- self-checking testbench for the SYSTEM clock/reset/WDT/CRC controller, built on tb/periph_tb_pkg.vhd (scoreboard, register-bus BFM, crc16_byte).
