-- VestaRV: pure-combinational single-cycle Zfinx FP block
-- Fed live rd1/rd2 in EXECUTE and consumed the same cycle, before writeback.
-- Ops (fp_s_op[3:0]): 0 FSGNJ 1 FSGNJN 2 FSGNJX 3 FEQ 4 FLT 5 FLE 6 FMIN 7 FMAX 8 FCLASS. No flags for fsgnj* and fclass; NV only for feq(sNaN), flt and fle (any NaN), and fmin and fmax (sNaN).
