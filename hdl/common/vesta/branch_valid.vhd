-- VestaRV: branch-condition evaluator
-- Decides from funct3 and the ALU's Zero flag whether the branch is taken. The main decoder points the ALU at subtract for equality branches and at slt or sltu for the ordered ones, so every condition reduces to Zero or its inverse.
library IEEE;
