-- VestaRV: Argus testbench, 18 harts
-- Hart 0 is the pass/fail gate; harts 1..17 are watched through tile monitors a0_1..a0_17.
-- Generated by platform/common (make chip / tb_vhd.py) from platform/common/hdl_templates/riscv_tb.template.vhd.
-- Do not edit; change the template or python/tb_vhd.py, regenerate, and keep
-- check_riscv_tb_vhd.py at exit 0 (byte-identical at N=4).
