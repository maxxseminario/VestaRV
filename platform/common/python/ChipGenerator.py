...
class ChipGenerator():
	...
	def generateMemoryMapVHD(self, outPath):
		...
		# Create the preamble
		s += '/* VestaRV: memory map package\n'
		s += '   Which RAM and peripheral slots are active, which slot each peripheral occupies, and which slot each register occupies inside its peripheral.\n'
		s += '   Generated on ' + generatedOnStamp() + ' by platform/common (make chip).\n'
		s += '   Do not edit this file: edit python/ChipGenerator.py, then regenerate. */\n'
