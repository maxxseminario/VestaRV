...
def _banner(stem, source):
    """The house comment at the top of one block header."""
    return ('/* VestaRV: ' + stem.upper() + ' registers.\n'
            '   Generated from hdl/common/regs/rdl/' + source
            + ' by platform/common/python/rdl_cheader_regs.py.\n'
            + _REGEN)
...
def emitBlockHeader(flag, outPath):
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        with open(tmpOut) as f:
            text = f.read()
    return _splice(text, _enumLines(root),
                   _banner(_blockFileStem(flag), flag['source']))
