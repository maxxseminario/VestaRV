-- MCU.template.i2c1.vhd: I2C1-conditional verbatim blocks, delimited by the @I2C1BLOCK:<name>@ markers.
-- python/mcu_vhd.py splices them into MCU.template.vhd only when peripherals.i2c1 is true (the default).
-- Without i2c1 nothing is emitted: window slot 15 reads zero via the mux fall-through, vectors 70-82 become IRQB_RSVD*, the SDA1/SCL1 planes go hi-Z.
