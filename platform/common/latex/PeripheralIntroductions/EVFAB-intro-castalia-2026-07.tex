% VestaRV: event fabric chapter of the TRM.
...
% and events / Programming / Usage notes). A table caption must sit outside its
% tabular, or the List of Tables numbering breaks.
\section{Overview}
