% VestaRV: clock-tree material for the TRM's "Reset, clocks and power" chapter.
% Input by TRM.template.tex, which owns the \chapter; this file carries the
% \section{Clock tree} (label s:clocktree, referenced by the template) and the
% \subsection headings under it. The SYSTEM chapter keeps the register-level
% description of SYSCLKCR/CLKDIVCR and points here.
