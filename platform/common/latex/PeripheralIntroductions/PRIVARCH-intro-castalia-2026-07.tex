...
Illegal instruction (including an access to an unimplemented or privileged control register) & \texttt{2} & The faulting instruction encoding & The faulting instruction \\
