...
class ChipGenerator():
	...
	def Generate(self, test=True, force=False, saveHardware=True, saveSoftware=True):
		...
		# Updated to output to tools/build and software directories
		cHeaderPath = self.ChipRootDirectory + '/../../software/commune/include/MemoryMap.h'
		...
		memoryMapVHDPath =  self.ChipRootDirectory + '/../../hdl/myshkin/MemoryMap.vhd'
		latexUserGuidePath =  self.ChipRootDirectory + '/latex/TRM'
		signalRoutingVHDPath =  self.ChipRootDirectory + '/../../hdl/myshkin/MCU.vhd'
