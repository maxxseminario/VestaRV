# MMMC view definition -- chip_top CONNECTED chip (Castalia C0, M15 Flavor B).
# Same corners/libs as the MCU_MP assembly (viewdefinition_top.tcl); the SDC is
# the mcu0/-prefixed chip transform (in/chip_top.sdc -- port load/driver lines
