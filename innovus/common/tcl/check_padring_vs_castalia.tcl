...
# generated platform/common ring).
#
...
# (platform/common/out/pnr/chip_top_padring.tcl, from the package model in
...
#                (default ../../platform/common/out/pnr/chip_top_padring.tcl,
#                 relative to the innovus/common run dir)
...
proc check_padring_vs_castalia {{genFile ""}} {
    if {$genFile eq ""} {
        set genFile "../../platform/common/out/pnr/chip_top_padring.tcl"
    }
