...
# a resynth rename can't abort the run). NETLIST-DEPENDENT names: re-derive
# after any MCU_ARGUS_hier re-synth with
#   grep -nE '\.AN \(control_reg\[16\]\), \.B \(clock_source\)' \
#        innovus/common/in/MCU_ARGUS_hier.pnr.v
# (NAND2B in module TIMER -> timer0, TIMER_1 -> timer1; prefix mcu0/ here).
# M19 re-emit (Stage 4) renamed g11710 -> g3282 (timer0) / g3281 (timer1).
set_interactive_constraint_modes [all_constraint_modes -active]
foreach g {mcu0/timer0/g3282 mcu0/timer1/g3281} {
...
# Castalia chip flow (also design chip_top) cannot clobber it.
