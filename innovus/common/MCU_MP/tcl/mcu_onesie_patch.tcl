...
# LOCATION: this is an MCU_MP script (dbs/MCU_MP.*, out/MCU_MP.*). It was
# misfiled into MCU_ARGUS/tcl by the 2026-07-27 reorg; moved home 2026-07-29.
# Coordinates are CUT-SPECIFIC to the 2026-07-12 PG4 MCU_MP cut — regenerate
# the site list before re-running after ANY MCU_MP re-P&R.
...
if {$__trial} {
	streamOut out/MCU_MP.trial.gds2 \
		...
		-merge [list ../hart_tile/out/hart_tile.gds2] -mapFile ../shared/innovus2gds.map
