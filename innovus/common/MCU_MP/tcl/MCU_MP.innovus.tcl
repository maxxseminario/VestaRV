...
# irq_gf3 (sources 96-127) exists in every config since GPIO4/5 (D1/D3)
# pushed the source list past 96; an unplaced GF macro NRIG-92s nanoroute
# (found on the Stage-F2a MCU_DP assembly). GUARDED: the Jul-17 hier netlist
# on disk is pre-GPIO4/5 (3 GFs) -- the guard makes this a no-op until
# MCU_MP_hier is regenerated from current RTL. 1041 centers the 31 um macro
# on the 1050-1064 stripe pair (gf2-fix idiom); the jogging sroute backstop
# below is already extended to 1085.
if {[dbGet -p top.insts.name irq_gf3] ne "0x0"} {
