################################################################################
# Innovus script -- MCU_DP (CastaliaDP respin) TOP-LEVEL ASSEMBLY (M14 physical flow; M16 rework)
#
...
#
# Netlist: in/MCU_DP_hier.pnr.v = out-of-genus MCU_DP_hier.genus.v with any
...
# Design import
################################################################################
set init_verilog             "$INPUT_DIR/MCU_DP_hier.pnr.v"
...
toc
printStatus "MCU_DP top assembly complete"
exit
