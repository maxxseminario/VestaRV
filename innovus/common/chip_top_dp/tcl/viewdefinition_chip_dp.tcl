# MMMC view definition -- chip_top_dp CONNECTED chip (CastaliaDP G2, LQFP-100).
# Same corners/libs as the MCU_MP assembly (viewdefinition_top.tcl); the SDC is
# the mcu0/-prefixed chip transform (in/chip_top_dp.sdc -- port load/driver lines
...
# libs). The tile enters as a per-corner ETM (../hart_tile/out/hart_tile.etm_{ss,ff}.lib);
