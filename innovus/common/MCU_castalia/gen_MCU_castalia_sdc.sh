#!/bin/bash
# =============================================================================
# gen_MCU_castalia_sdc.sh -- build in/MCU_castalia.sdc from the WOUND
...
# in/MCU_castalia.sdc must differ from in/chip_top_wound.sdc by exactly
...
#
# The chip-top run is FLAT: MCU_castalia instantiates the pads and `MCU mcu0`,
...
# tcl/MCU_castalia.innovus.tcl is what actually preserves the rings. If the
# hierarchical wound SDC emits the same shape, fix it in the genus flow.
#
# Usage: ./gen_MCU_castalia_sdc.sh [SRC_SDC] [DST_SDC]
#   defaults: ../../../genus/MCU_WOUND/out/MCU_WOUND_hier.genus.sdc -> in/MCU_castalia.sdc
