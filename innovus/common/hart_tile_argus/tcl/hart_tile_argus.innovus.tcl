...
#
# INPUTS: ../../../genus/hart_tile_argus/out/hart_tile_argus.genus.{v,sdc} (SH_AW=16, 16-bit
# sh_addr). OUTPUTS carry the _argus basename so the Castalia tile artifacts
# (../hart_tile/out/hart_tile.*, SH_AW=15, U-shape) stay pristine. The MODULE/MACRO name is
