# MMMC view definition -- MCU_WOUND (wound-patch SoC) top-level assembly (M14).
# Cloned from viewdefinition_top_dp.tcl; ONLY the constraint_mode SDC changes.
# Library sets are identical because the macro set is identical (rom_hvt_pg,
# sram1p16k_hvt_pg, hardened hart_tile ETM) -- the wound deltas (QSPI/I3C/NFC/
# OW/I2CT/TRNG/EVFAB) are all std-cell logic. The wound SDC additionally
# carries `set_dont_touch [get_cells u_ro]` + 210 ring-cell lines (the TRNG
# ring-oscillator ensemble, deliberate combinational loops); the DB-side
# dontTouch is set in MCU_WOUND.innovus.tcl.
...
create_constraint_mode \
    ...
    -sdc_files "$GENUS_DIR/out/MCU_WOUND_hier.genus.sdc"
