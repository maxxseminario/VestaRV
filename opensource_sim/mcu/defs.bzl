...
_MCU_EXTRA = [
    ...
    "hdl/common/periph/gpio_regs_pkg.vhd",
    "hdl/common/periph/GPIO.vhd",
    "hdl/common/periph/spi_regs_pkg.vhd",
    "hdl/common/periph/SPI.vhd",
    "hdl/common/periph/qspi_regs_pkg.vhd",
    "hdl/common/periph/QSPI.vhd",
    "hdl/common/periph/i3c_regs_pkg.vhd",
    "hdl/common/periph/I3C.vhd",
    "hdl/common/periph/nfc_regs_pkg.vhd",
    "hdl/common/periph/NFC.vhd",
    "hdl/common/periph/rtc_regs_pkg.vhd",
    "hdl/common/periph/RTC.vhd",
    "hdl/common/periph/pwm_regs_pkg.vhd",
    "hdl/common/periph/PWM.vhd",
    "hdl/common/periph/onewire_regs_pkg.vhd",
    "hdl/common/periph/OneWire.vhd",
    "hdl/common/periph/i2ctarget_regs_pkg.vhd",
    "hdl/common/periph/I2CTarget.vhd",
    "hdl/common/periph/evfab_regs_pkg.vhd",
    "hdl/common/periph/EVFAB.vhd",
    "hdl/common/periph/uart_regs_pkg.vhd",
    "hdl/common/periph/UART.vhd",
    "hdl/common/periph/i2c_regs_pkg.vhd",
    "hdl/common/periph/I2C.vhd",
    "hdl/common/periph/timer_regs_pkg.vhd",
    "hdl/common/periph/TIMER.vhd",
    "hdl/common/periph/system_regs_pkg.vhd",
    "hdl/common/periph/SYSTEM.vhd",
    "hdl/common/periph/npu_regs_pkg.vhd",
    ...
    "hdl/common/periph/clint_regs_pkg.vhd",
    "hdl/common/clint.vhd",
    "hdl/common/periph/irq_router_regs_pkg.vhd",
    "hdl/common/irq_router.vhd",
    "hdl/common/mp_arbiter.vhd",
    "hdl/common/periph/mutex_bank_regs_pkg.vhd",
    "hdl/common/mutex_bank.vhd",
    "hdl/common/periph/pwr_ctrl_regs_pkg.vhd",
    "hdl/common/pwr_ctrl.vhd",
    "hdl/common/resv_unit.vhd",
    "hdl/common/hart_tile.vhd",
    "hdl/common/afe_stub.vhd",
    "hdl/common/periph/debug_module_regs_pkg.vhd",
