...
# hand-written RTL hdl/MCU_MP/tb/riscv_tb.vhd. Like check_mcu_vhd.py the bar is
...
def main():
	...
	rtlPath = args[1] if len(args) > 1 else os.path.join(here, '..', '..', 'hdl', 'MCU_MP', 'tb', 'riscv_tb.vhd')
