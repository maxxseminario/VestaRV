...
class ChipGenerator():
	...
	def Generate(self, test=True, force=False, saveHardware=True, saveSoftware=True):
		...
		# CASTALIA: ALL outputs stay inside this chip's own directory tree (platform_castalia/).
		# Nothing here may write into hdl/MCU_MP/, software/, or tools/ — the generated HDL goes
