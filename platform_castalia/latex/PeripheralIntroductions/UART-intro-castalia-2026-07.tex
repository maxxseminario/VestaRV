...
Both UARTs live in the shared window behind the multi-core arbiter (see Section \ref{s:multicore}), so all four harts can use them. \peripheral{UART0} is the \textit{console UART}: it carries the boot-time Forth console and has its own dedicated window at \texttt{0x12000} rather than a slot in the shared peripheral page. \peripheral{UART1} sits in the shared peripheral page at \texttt{0x13500}.
