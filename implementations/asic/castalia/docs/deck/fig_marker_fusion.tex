...
\begin{tikzpicture}
  \begin{axis}[
    ...
    \addplot[draw=black!45, fill=black!22] coordinates
      {(HE4,63.8) (CA-125,62.8) (CEA,38.8) (CA19-9,35.7)};
    \addplot[draw=mtxA!60!black, fill=mtxA!85] coordinates {(fused,90.8)};
    ...
    \node[font=\small\bfseries, mtxA!55!black, anchor=north, align=center]
      at (rel axis cs:0.905,0.72) {all four,\\ fused};
  \end{axis}
\end{tikzpicture}
