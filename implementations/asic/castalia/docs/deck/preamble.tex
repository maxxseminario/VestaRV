...
% Only the section names in the sidebar are set darker than beaver's default,
% which washes out on a projector.
\setbeamercolor{section in sidebar}{fg=black!80}
\setbeamercolor{section in sidebar shaded}{fg=black!50}
\setbeamercolor{subsection in sidebar}{fg=black!70}
\setbeamercolor{subsection in sidebar shaded}{fg=black!45}
\usepackage{hyperref}
