...
\begin{itemize}\setlength{\itemsep}{0pt}\setlength{\parskip}{0pt}
  \item[{[1]}] National Cancer Institute, \emph{SEER Cancer Stat Facts}, per-site pages, seer.cancer.gov/statfacts, accessed 20 Sep.\ 2026. Stage and survival: SEER 21, 2016--2022; cases and deaths: 2026 estimates.
  \item[{[2]}] D.~C. Grossman \emph{et al.}, ``Screening for ovarian cancer: USPSTF recommendation statement,'' \emph{JAMA}, vol.~319, pp.~588--594, 2018.
  \item[{[3]}] US Preventive Services Task Force, \emph{A and B Recommendations}; \emph{Prostate Cancer: Screening}, 2018; \emph{Pancreatic Cancer: Screening}, 2019. uspreventiveservicestaskforce.org.
  \item[{[4]}] U.~Menon \emph{et al.}, ``Ovarian cancer population screening and mortality after long-term follow-up in the UK Collaborative Trial of Ovarian Cancer Screening (UKCTOCS),'' \emph{Lancet}, vol.~397, pp.~2182--2193, 2021.
  \item[{[5]}] F.~Chen \emph{et al.}, ``Clinical analysis of four serum tumor markers in 458 patients with ovarian tumors: combined use of HE4, CA125, CA19-9, and CEA,'' \emph{Cancer Manag.\ Res.}, vol.~10, pp.~1313--1318, 2018.
  \item[{[6]}] R.~G. Moore \emph{et al.}, ``A novel multiple marker bioassay utilizing HE4 and CA125 for the prediction of ovarian cancer in patients with a pelvic mass,'' \emph{Gynecol.\ Oncol.}, vol.~112, pp.~40--46, 2009.
  \item[{[7]}] US Preventive Services Task Force, \emph{Grade Definitions} (current, after July 2012), uspreventiveservicestaskforce.org, accessed 20 Sep.\ 2026.
\end{itemize}}
\end{frame}
