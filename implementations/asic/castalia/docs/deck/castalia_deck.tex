...
{\scriptsize USPSTF: A/B recommended; C offered selectively; D recommended \emph{against}; none: no statement.}
\vspace{0.1cm}
...
\begin{itemize}
  \item[{[1]}] National Cancer Institute, \emph{SEER Cancer Stat Facts}, per-site pages, \url{https://seer.cancer.gov/statfacts/}, accessed 20 Sep.\ 2026. Stage and 5-year relative survival: SEER 21, 2016--2022; cases and deaths: 2026 estimates.
  \item[{[2]}] D.~C. Grossman \emph{et al.}, ``Screening for ovarian cancer: US Preventive Services Task Force recommendation statement,'' \emph{JAMA}, vol.~319, no.~6, pp.~588--594, 2018.
  \item[{[3]}] US Preventive Services Task Force, \emph{A and B Recommendations}; \emph{Prostate Cancer: Screening}, 2018 (C); \emph{Pancreatic Cancer: Screening}, 2019 (D). \url{https://www.uspreventiveservicestaskforce.org/}.
  \item[{[4]}] U.~Menon \emph{et al.}, ``Ovarian cancer population screening and mortality after long-term follow-up in the UK Collaborative Trial of Ovarian Cancer Screening (UKCTOCS),'' \emph{The Lancet}, vol.~397, pp.~2182--2193, 2021.
  \item[{[5]}] F.~Chen \emph{et al.}, ``Clinical analysis of four serum tumor markers in 458 patients with ovarian tumors: diagnostic value of the combined use of HE4, CA125, CA19-9, and CEA,'' \emph{Cancer Manag.\ Res.}, vol.~10, pp.~1313--1318, 2018.
  \item[{[6]}] R.~G. Moore \emph{et al.}, ``A novel multiple marker bioassay utilizing HE4 and CA125 for the prediction of ovarian cancer in patients with a pelvic mass,'' \emph{Gynecol.\ Oncol.}, vol.~112, no.~1, pp.~40--46, 2009.
\end{itemize}}
\end{frame}
