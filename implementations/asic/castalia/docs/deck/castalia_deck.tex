...
\sowhat{No impedance hardware: the mode adds a clock divider and an accumulate to the channel. Against a known $Z_{\mathrm{cal}}$ the converter LSB, the square's $4/\pi$ and $R_f$ all cancel.}
\end{frame}
