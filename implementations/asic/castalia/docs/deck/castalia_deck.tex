...
\begin{frame}{No single ovarian marker is a usable test [5]}
\begin{columns}[T]
...
\midrule
ROMA, FDA-cleared [6] & 2 markers \\
This chip          & 4 channels \\
\bottomrule
\end{tabular}}
\end{columns}
\sowhat{Clinical data (458 patients), not simulation. The decision is a learned combination, so the unit of integration is four concurrent channels plus the processor fusing them.}
\end{frame}

% Sources: Chen 2018 [5] sensitivities and the four-marker panel; Moore 2009 [6]
% for HE4/ROMA; Charkhchi 2020 [8] for CA-125.  Cut-offs are the clinical
% decision points used on the dose-response slide.
\begin{frame}{The four markers}
\centering
{\footnotesize
\resizebox{\linewidth}{!}{%
\begin{tabular}{@{}l>{\raggedright\arraybackslash}p{5.2cm}>{\raggedright\arraybackslash}p{4.8cm}rr@{}}
\toprule
Marker & What it is & Where it fails alone & Cut-off & Sens.\ [5] \\
\midrule
\textbf{CA-125} & epitope on MUC16, a 3--5\,MDa membrane mucin shed by ovarian epithelium [8] & raised in only half to two thirds of stage~I; confounded by endometriosis, fibroids, ascites [8] & 35\,U/mL & 62.8\,\% \\
\addlinespace
\textbf{HE4} & human epididymis protein 4 (WFDC2), $\sim$25\,kDa secreted glycoprotein; CA-125's partner in ROMA [6] & silent in mucinous tumours & 70\,pmol/L & 63.8\,\% \\
\addlinespace
\textbf{CA19-9} & sialyl-Lewis$^{\mathrm{a}}$ carbohydrate antigen carried on mucins; the pancreatic and GI marker & non-specific alone; picks up the mucinous subtype the first two miss & 37\,U/mL & 35.7\,\% \\
\addlinespace
\textbf{CEA} & carcinoembryonic antigen (CEACAM5), $\sim$180\,kDa glycoprotein; the colorectal marker & non-specific alone; mucinous and GI-type tumours & 5\,ng/mL & 38.8\,\% \\
\midrule
\multicolumn{4}{@{}l}{\textbf{All four, fused} [5]} & \textbf{90.8\,\%} \\
\bottomrule
\end{tabular}}}
\sowhat{Two epithelial markers plus two mucinous/GI markers: the fusion works because each covers a subtype the others miss.}
\end{frame}
...
% Sources: TRM sch_tiarprog_switch, tab_tiarprog_lin (corners), tab_tiarprog_mc.
\begin{frame}{Feedback resistor: switch structure, corners, mismatch}
\begin{columns}[T]
\column{0.44\textwidth}
\trmfit[10cm]{\linewidth}{6.2cm}{\MaestroRoot sch_tiarprog_switch.tex}
\column{0.54\textwidth}
\trmfit[12cm]{\linewidth}{3.0cm}{\MaestroRoot tab_tiarprog_lin.tex}
\vspace{0.15cm}

\trmfit[12cm]{\linewidth}{2.8cm}{\MaestroRoot tab_tiarprog_mc.tex}
\end{columns}
{\centering\bsim\quad\bmc\par}
\end{frame}

% Source: TRM sch_adc_sar (analog/).
\begin{frame}{SAR ADC: charge-redistribution architecture}
\centering\trmfit[20cm]{\linewidth}{6.4cm}{\MaestroRoot sch_adc_sar.tex}
\end{frame}
...
% Source: TRM sch_dacr2r12_ladder (analog/).
\begin{frame}{Reference DAC: 12-bit voltage-mode R--2R ladder}
\centering\trmfit[20cm]{\linewidth}{6.4cm}{\MaestroRoot sch_dacr2r12_ladder.tex}
\end{frame}
...
% Sources: TRM sch_biasgen_core, tab_biasgen_temp_stats.
\begin{frame}{Local bias generator}
\begin{columns}[T]
\column{0.50\textwidth}
\trmfit[12cm]{\linewidth}{6.2cm}{\MaestroRoot sch_biasgen_core.tex}
\column{0.48\textwidth}
\trmfit[12cm]{\linewidth}{6.0cm}{\MaestroRoot tab_biasgen_temp_stats.tex}
\end{columns}
{\centering\bsim\par}
\end{frame}
