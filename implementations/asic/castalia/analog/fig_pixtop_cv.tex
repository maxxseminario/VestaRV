%% VestaRV: hand-written TRM fragment, not maestro2tex output (XY figure kind; the
...
\begin{figure}[htbp]
  ...
  cyclic voltammogram of the electrode of
  Section~\ref{ss:analog-electrode-bc} at \SI{2}{\volt\per\second},
  \SI{37}{\celsius}, nominal process point, taken through the complete
  assembled channel: real 12-bit potential codes and the real programmable
  feedback resistor at \(N = 3\) (\SI{37.16}{\kilo\ohm} measured in the
  loop). One point per
