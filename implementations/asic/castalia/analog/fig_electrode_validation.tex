%% VestaRV: hand-written TRM fragment, not maestro2tex output. The engine has no
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    \begin{axis}[elecax,
      ...
      \addlegendentry{electrode model}
    \end{axis}
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}}
  \caption[{Validation of the electrode model against closed-form
  voltammetry.}]{Standalone validation of the electrode model against
