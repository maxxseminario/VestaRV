%% VestaRV: hand-written TRM fragment, not maestro2tex output (raw Spectre Monte
...
%% 2026-08-26: the Section~\ref{sss:eis-accuracy} pointer was dropped from the
%% caption -- the impedance section no longer carries subsubsections.  The claim
%% it pointed at (above the feedback pole a dc calibration stops working) is in
%% note_eis_accuracy.tex, in the same section.
