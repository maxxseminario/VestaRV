...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
  \end{tikzpicture}}
  \caption[{Loop phase for the same five runs.}]{Loop phase for the same five runs. In this convention \SI{0}{\degree} is the instability point, so the phase at crossover is the phase margin directly: \SIrange{61.2}{64.9}{\degree}. Cadence's \texttt{phaseMargin()} returns exactly \SI{180}{\degree} less on this result and is not used here or in Section~\ref{ss:controlamp}.}
