%% VestaRV: hand-written TRM table, not maestro2tex output.
...
\begin{table}[htbp]
  \centering
  \caption[{Peak current and peak separation of the electrode model against
  Randles--\v{S}ev\v{c}\'ik.}]{Peak metrics of the electrode model against
