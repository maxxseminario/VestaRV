...
The typical point is simulated at \SI{27}{\celsius} and the four process corners at
\SI{25}{\celsius}. The resistor and MIM model rows are typical in all five corners;
only the standard-MOS rows vary.
