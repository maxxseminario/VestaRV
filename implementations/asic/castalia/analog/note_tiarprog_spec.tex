...
% In-loop noise, hand-written and appended here rather than given its own fragment
% because TiaRprog.tex is maestro2tex output and its input list cannot be hand-extended.
%
